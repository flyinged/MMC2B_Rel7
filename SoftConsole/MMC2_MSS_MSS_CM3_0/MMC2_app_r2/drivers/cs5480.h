...
/* init values */
#define 	CS5480_CONFIG0_DEF  (0xC02000 | CS5480_CONFIG0_I1PGA | CS5480_CONFIG0_I2PGA) //50x gain in current channels
#define 	CS5480_CONFIG1_DEF   0x00EEEE //default settings for output pins (unused)
#define 	CS5480_MASK_DEF      0x000000 //no interrupt active
//#define 	CS5480_PC_DEF        0x000000 //phase compensation control
//#define 	CS5480_SERCTL_DEF    0x02004D //serial interface control
//#define 	CS5480_ZXNUM_DEF     0x000064 //number of zero crossings for line frequency detection
#define 	CS5480_CONFIG2_DEF  (0x000200 | \
                                 CS5480_CONFIG2_IHOLD | \
                                 CS5480_CONFIG2_AFC   | \
                                 CS5480_CONFIG2_V1_HP | \
                                 CS5480_CONFIG2_I1_HP | \
                                 CS5480_CONFIG2_V2_HP | \
                                 CS5480_CONFIG2_I2_HP   \
                                 ) //No auto channel selection

#define 	CS5480_I1ACOFF_DEF   0x000000 //offset
#define 	CS5480_I1DCOFF_DEF   0x000000 //offset
#define 	CS5480_V1DCOFF_DEF   0x000000 //offset
#define 	CS5480_P1OFF_DEF     0x000000 //offset
#define 	CS5480_Q1OFF_DEF     0x000000 //offset
#define 	CS5480_I2ACOFF_DEF   0x000000 //offset
#define 	CS5480_I2DCOFF_DEF   0x000000 //offset
#define 	CS5480_V2DCOFF_DEF   0x000000 //offset
#define 	CS5480_P2OFF_DEF     0x000000 //offset
#define 	CS5480_Q2OFF_DEF     0x000000 //offset
#define 	CS5480_I1GAIN_DEF    0x400000 //gain = 1
#define 	CS5480_V1GAIN_DEF    0x400000 //gain = 1
#define 	CS5480_I2GAIN_DEF    0x400000 //gain = 1
#define 	CS5480_V2GAIN_DEF    0x400000 //gain = 1

//#define 	CS5480_ICHANLV_DEF   0x828F5C //automatic channel selection level
#define 	CS5480_TGAIN_DEF     0x06B716 //temperature gain
#define 	CS5480_TOFF_DEF      0xD53998 //temperature offset
//#define 	CS5480_PMIN_DEF      0x00624D //min level for auto channel selection
//#define 	CS5480_TSETTLE_DEF   0x00001E //filter settle time after conversion
//#define 	CS5480_LOADMIN_DEF   0x000000 //threshold for no-load detection
//#define 	CS5480_VFRMS_DEF     0x5A8259 //voltage fixed RMS reference
//#define 	CS5480_SYSGAIN_DEF   0x500000 //system gain (1.25), range [-2.0:2.0)

#define     CS5480_SAMPCNT_DEF   3*0xFE0 //default 0xFE0
#define 	CS5480_STATUS0_DEF   0xE7FFFD //reset all interrupts
...
#define     CS5480_CONFIG2_V1_HP  0x000002 //HP filter enable for v1
#define     CS5480_CONFIG2_V1_PM  0x000004 //PM filter enable for v1
#define     CS5480_CONFIG2_I1_HP  0x000008 //HP filter enable for i1
#define     CS5480_CONFIG2_I1_PM  0x000010 //PM filter enable for i1
#define     CS5480_CONFIG2_V2_HP  0x000020 //HP filter enable for v2
#define     CS5480_CONFIG2_V2_PM  0x000040 //PM filter enable for v2
#define     CS5480_CONFIG2_I2_HP  0x000080 //HP filter enable for i2
#define     CS5480_CONFIG2_I2_PM  0x000100 //PM filter enable for i2
...
#define CS5480_ICHANLV 0x32 //default 0x828F5C (auto chan select level)
