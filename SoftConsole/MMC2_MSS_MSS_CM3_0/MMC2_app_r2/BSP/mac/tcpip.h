...
//ML84 added
#define DHCP_INIT  0 //INIT
#define DHCP_SEL   1 //SELECTING
#define DHCP_REQ   2 //REQUESTING
#define DHCP_BOUND 3 //BOUND
#define DHCP_REN   4 //RENEWING
#define DHCP_REB   5 //REBINDING
